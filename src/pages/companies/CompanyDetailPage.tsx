...
import { Company, Job, CompanyReview } from '@/shared/types';
  ...
  const mockReviews: CompanyReview[] = [
    {
      ...
      content: 'Working at this company has been an incredible experience. The team is supportive, the projects are challenging, and there are plenty of opportunities to learn and grow.',
      pros: ['Great work-life balance', 'Supportive management', 'Learning opportunities', 'Competitive salary'],
      cons: ['Fast-paced environment', 'Limited remote work options'],
      advice: 'Come prepared to learn and grow. The company invests heavily in employee development.',
    ...
    },
    {
      ...
      content: 'Overall a good place to work. The benefits are competitive and the team is friendly. Some processes could be improved but management is open to feedback.',
      pros: ['Good benefits', 'Friendly team', 'Open to feedback', 'Stable company'],
      cons: ['Some outdated processes', 'Could use more innovation'],
      advice: 'Be proactive about suggesting improvements. Management is receptive to new ideas.',
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (foundCompany) {
        ...
        const jobs = mockJobs.filter(job => job.companyId === foundCompany.id);
        setCompanyJobs(jobs);
      }
      setIsLoading(false);
    }, 500);
          ...
          <CardContent className="p-8 -mt-12 relative z-10">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-6 text-gray-600">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>{getEmployeeCountDisplay(company.size, company.stats.totalEmployees)} employees</span>
                    </div>
                    <div className="flex items-center">
              ...
              <div className="flex items-center gap-3 lg:flex-shrink-0">
                ...
                {company.socialLinks.website && (
                  <Button 
                    variant="outline"
                    onClick={() => window.open(company.socialLinks.website, '_blank')}
                  >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8 pt-6 border-t">
              <div className="text-center">
                ...
                <div className="text-2xl font-bold text-gray-900">{company.stats.averageRating}</div>
                <div className="text-sm text-gray-600">{company.stats.totalReviews} reviews</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 mb-1">{company.stats.responseRate}%</div>
                <div className="text-sm text-gray-600">Response Rate</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600 mb-1">{company.stats.avgResponseTime}d</div>
                <div className="text-sm text-gray-600">Avg Response Time</div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center mb-1">
                  <TrendingUp className="h-5 w-5 text-green-500 mr-1" />
                  <span className="text-2xl font-bold text-green-600">{company.stats.hiringGrowth}%</span>
                </div>
                ...
                <Card className="shadow-sm border-0">
                  ...
                  <CardContent>
                    ...
                    {company.values && company.values.length > 0 && (
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-3">Values</h4>
                    ...
                    <CardContent>
                      ...
                      {companyJobs.length > 3 && (
                        <div className="text-center mt-6">
                          <Button onClick={() => navigate(`/jobs?company=${company.id}`)}>
                ...
                <Card className="shadow-sm border-0">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{getHQLocation(company)}</span>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {company.socialLinks.linkedin && (
                      <Button 
                        variant="outline" 
                        className="w-full justify-start"
                        onClick={() => window.open(company.socialLinks.linkedin, '_blank')}
                      >
                    ...
                    {company.socialLinks.twitter && (
                      <Button 
                        variant="outline" 
                        className="w-full justify-start"
                        onClick={() => window.open(company.socialLinks.twitter, '_blank')}
                      >
              ...
              <Card className="shadow-sm border-0">
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    ...
                    Follow them to get notified when new jobs are posted.
                  </p>
                </CardContent>
              </Card>
            )}
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <div>
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                              ...
                              <span>•</span>
                              <span className="capitalize">{review.employmentType} employee</span>
                              <span>•</span>
                              <span>{review.yearsWorked} year{review.yearsWorked !== 1 ? 's' : ''}</span>
                            </div>
                          </div>
                          <div className="flex items-center">
                        ...
                        {review.advice && (
                          <div className="bg-blue-50 p-4 rounded-lg mb-4">
                            <h5 className="font-medium text-blue-900 mb-2">Advice to Management</h5>
                            <p className="text-sm text-blue-800">{review.advice}</p>
                          </div>
                        )}
