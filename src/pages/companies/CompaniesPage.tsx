...
import { Company, CompanyFilter, CompanySize } from '@/shared/types';
...
export function CompaniesPage() {
  ...
  const [filters, setFilters] = useState<CompanyFilter>({
    ...
    industry: searchParams.get('industry') ? [searchParams.get('industry')!] : undefined,
    page: 1,
    limit: 12,
    sortBy: 'name',
    sortOrder: 'asc'
  ...
  useEffect(() => {
    ...
    if (filters.minRating) {
      companies = companies.filter(company => 
        company.stats.averageRating >= filters.minRating!
      );
    }
    ...
    switch (sortBy) {
      ...
      case 'jobs':
        ...
        break;
      case 'employees':
        companies.sort((a, b) => b.stats.totalEmployees - a.stats.totalEmployees);
        break;
      case 'founded':
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Explore Companies</h1>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Showing {((currentPage - 1) * 12) + 1} - {Math.min(currentPage * 12, totalCompanies)} of {totalCompanies.toLocaleString()} results
            </p>
          </div>
        ...
        {/* Active Filters */}
        {(filters.query || filters.industry?.length || filters.size?.length || filters.minRating || filters.hasJobs || filters.isVerified) && (
          <div className="mt-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              <Button
                ...
                size="sm"
                onClick={() => {
                  setFilters({ page: 1, limit: 12, sortBy: 'name', sortOrder: 'asc' });
                  setSearchQuery('');
