...
export function JobDetailPage() {
  ...
  const handleSaveJob = () => {
    if (job) {
      ...
      setIsSaved(!isSaved); // Optimistic update for immediate UI feedback
    }
  };
              ...
              <CardContent className="p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <Badge
                      className={`capitalize ${getWorkLocationBadgeColor(
                        job.workLocation
                      )}`}
                    >
                ...
                {hasApplied ? (
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Your application has been sent to {job.companyName}. They
                      typically respond within 3-5 business days.
                    </p>
                    <Button
                      variant="outline"
                      className="w-full"
                        ...
                        <DialogContent>
                          ...
                          <div className="py-4">
                            <p className="text-sm text-gray-600">
                              Your profile and resume will be submitted to the
                              employer. Make sure your profile is complete for
